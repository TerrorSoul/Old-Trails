    ...
    useEffect(() => {
        ...
        const handleDownloadComplete = ({ success, message }) => {
            ...
            if (!success && message) {
                ...
                if (success) setTimeout(() => setStatusMessage('Ready.'), 5000);
            }
        };
        ...
        const handleLoginFailed = () => {
            setPassword('');
            // Optional: you could show an explicit alert or just rely on the statusMessage set by the main process
        };
        ...
        return () => {
            [
                ...
                'steam-mobile-required', 'steam-email-required', 'login-failed', 'download-complete', 
